...
Then  I should be navigated to Book category page
...
| sort by | Name: A to Z       | sorted product in the product name in alphabetical order A to Z |
| sort by | Name: Z to A       | sorted product in the product name in alphabetical order Z to A |
...
Scenario Outline: I should be able to see product display format according display format type s per given picture in srs document
Given I am on book page
